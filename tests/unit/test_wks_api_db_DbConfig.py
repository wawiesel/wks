...
class TestDbConfig:
    ...
    def test_db_config_mongo(self):
        ...
        config = DbConfig(type="mongo", prefix="wks", data={"uri": "mongodb://localhost:27017/"})
    ...
    def test_db_config_missing_prefix(self):
        ...
        with pytest.raises(ValidationError):
            DbConfig(type="mongo", data={"uri": "mongodb://localhost:27017/"})

    def test_db_config_custom_prefix(self):
        """Test DbConfig with custom prefix."""
        config = DbConfig(type="mongo", prefix="custom", data={"uri": "mongodb://localhost:27017/"})
    ...
    def test_db_config_unknown_type(self):
        ...
        with pytest.raises(ValueError, match="Unknown backend type"):
            DbConfig(type="invalid", prefix="wks", data={"uri": "mongodb://localhost:27017/"})
    ...
    def test_db_config_invalid_mongo_uri(self):
        ...
        with pytest.raises(Exception, match="must start with 'mongodb://'"):
            DbConfig(type="mongo", prefix="wks", data={"uri": "invalid-uri"})
