"""Unit tests for wks.api.db.app module."""
...
from wks.api.db.app import db_app, db_callback, reset_command, show_command
...
class TestDbApp:
    ...
    def test_db_callback_without_subcommand(self):
        ...
        with patch("wks.api.db.app.typer.echo") as mock_echo:
            with patch("wks.api.db.app.typer.Exit", side_effect=SystemExit) as mock_exit:
...
class TestShowCommand:
    ...
    def test_show_command_with_collection(self):
        ...
        with patch("wks.api.db.app.handle_stage_result") as mock_handle:
    ...
    def test_show_command_no_collection(self):
        ...
        with patch("wks.api.db.app.typer.echo") as mock_echo:
            with patch("wks.api.db.app.typer.Exit", side_effect=SystemExit(1)) as mock_exit:
