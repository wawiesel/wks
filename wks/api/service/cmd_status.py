...
def _check_service_status(config: WKSConfig, status_data: dict[str, Any]) -> tuple[bool, int | None, dict[str, Any]]:
...
def _build_result_message(terminal_pid: int | None, service_data: dict[str, Any], status_data: dict[str, Any]) -> str:
