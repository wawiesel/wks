...
*   Support the shared internal Python service/core API plus thin **CLI**, **MCP**, and read-only **REST** surfaces. REST support is mandatory and non-negotiable. Do not duplicate business logic across transports.
